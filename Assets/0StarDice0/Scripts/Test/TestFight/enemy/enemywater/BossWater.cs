...
public bool isBattleOver = false;
    ...
    private int enemyDef = 55; //def ของศัตรู
...
int nextLevelToUnlock = 3; // ⚠️ เปลี่ยนเลขนี้เป็นด่านถัดไปที่คุณอยากให้ปลดล็อค (เช่น ชนะด่าน 1 ให้ใส่เลข 2)
